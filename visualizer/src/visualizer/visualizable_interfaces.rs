...
impl VisualizableInterfaces {
    ...
    pub fn craft<'a>(robot: &'a mut (impl Runnable + Visalizable<'a>), world: &World, content: Content) -> Result<Content, LibError> {
    ...
    pub fn destroy<'a>(robot: &'a mut (impl Runnable + Visalizable<'a>), world: &mut World, direction: Direction) -> Result<usize, LibError> {
    ...
    pub fn discover_tiles<'a>(robot: &'a mut (impl Runnable + Visalizable<'a>), world: &mut World, to_discover: &[(usize, usize)]) -> Result<HashMap<(usize, usize), Option<Tile>>, LibError> {
    ...
    pub fn get_score<'a>(robot: &'a mut (impl Runnable + Visalizable<'a>), world: &World) -> f32 {
    ...
    pub fn go<'a>(robot: &'a mut (impl Runnable + Visalizable<'a>), world: &mut World, direction: Direction) -> Result<(Vec<Vec<Option<Tile>>>, (usize, usize)), LibError> {
    ...
    pub fn look_at_sky<'a>(robot: &'a mut (impl Runnable + Visalizable<'a>), world: &World) -> EnvironmentalConditions {
    ...
    pub fn one_direction_view<'a>(robot: &'a mut (impl Runnable + Visalizable<'a>), world: &World, direction: Direction, distance: usize) -> Result<Vec<Vec<Tile>>, LibError> {
    ...
    pub fn put<'a>(robot: &'a mut (impl Runnable + Visalizable<'a>), world: &mut World, content_in: Content, quantity: usize, direction: Direction) -> Result<usize, LibError> {
    ...
    pub fn robot_map<'a>(robot: &'a mut (impl Runnable + Visalizable<'a>), world: &World) -> Option<Vec<Vec<Option<Tile>>>> {
    ...
    pub fn robot_view<'a>(robot: &'a (impl Runnable + Visalizable<'a>), world: &World) -> Vec<Vec<Option<Tile>>> {
    ...
    pub fn teleport<'a>(robot: &'a mut (impl Runnable + Visalizable<'a>), world: &mut World, coordinates: (usize, usize)) -> Result<(Vec<Vec<Option<Tile>>>, (usize, usize)), LibError> {
    ...
    pub fn where_am_i<'a>(robot: &'a (impl Runnable + Visalizable<'a>), world: &World) -> (Vec<Vec<Option<Tile>>>, (usize, usize)) {
