...
use oxagworldgenerator::world_generator::{OxAgWorldGenerator, world_generator_builder::OxAgWorldGeneratorBuilder, presets::{content_presets::OxAgContentPresets, tile_type_presets::OxAgTileTypePresets}, content_options::OxAgContentOptions};
use robotics_lib::world::{world_generator::Generator, tile::Content};
...
const NO_BATCH: fn() -> Vec<(Content, OxAgContentOptions)> = || {
    Vec::from([
        // (
        //     Content::Rock(0),
        //     OxAgContentOptions {
